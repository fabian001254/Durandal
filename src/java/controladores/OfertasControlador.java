...
public class OfertasControlador implements Serializable {
    ...
    public void consultaEstado(Long doc){
        ...
        try {
            if(aspirantes.getEstado().equals("Inscrito a oferta")){
                campo = "Por ende, usted no podrá inscribirse a más ofertas hasta que finalice el proceso";
    ...
    public void InscribirseEnLaOferta(int id,Long doc){
        try {
            ...
            enviarCorreo("Inscripción a oferta exitosa",1);
    ...
    public String mensajeConEstiloInscripcion(String nombre1, String apellido1){
        return "<h1 style=\"font-size: 20px; color:#0C0; font-weight: bold; text-transform: uppercase ; \">Opta/Durandal" + "</h1>" + "<img src='https://i.ibb.co/3cwRywd/imagen.png'/ style=\"float: left;width: 450px; height:300px;\"><p>"
                    ...
                    + "<p> El día de hoy usted se inscribió a la oferta de la empresa: \n"+ofertas.getIdApartes().getNumerodocumentocliente().getRazonsocial()  
                    +"<p> Esto hace que no se pueda inscribir a otras ofertas mientras este inscrito a una, tendrá que esperar a que termine el proceso</p></br><p>Ahora su estado es: INSCRITO A OFERTA</p>"
                    + "<p> ¿Qué quiere decir este estado?: "
                    +"<p>Actualmente está inscrito a una oferta, esto hace que no se pueda inscribir a otras ofertas mientras este inscrito a una, tendrá que esperar a que termine el proceso de la oferta"
    ...
    public String mensajeConEstiloR(String nombre1, String apellido1){
        return "<h1 style=\"font-size: 20px; color:#0C0; font-weight: bold; text-transform: uppercase ; \">Opta/Durandal" + "</h1>" + "<img src='https://i.ibb.co/3cwRywd/imagen.png'/ style=\"float: left;width: 450px; height:300px;\"><p>"
                    ...
                    +"<p> A partir de este momento podrá inscribirse a otra oferta</p></br><p>Ahora su estado es: RECLUTADO</p>"
